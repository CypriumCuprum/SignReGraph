...
from signregraph.datasets import build_dataloader, build_dataset
from signregraph.models import build_model
from signregraph.utils import cache_checkpoint, mc_off, mc_on, test_port
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='signregraph test (and eval) a model')
