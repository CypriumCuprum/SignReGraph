...
from signregraph import __version__
from signregraph.apis import init_random_seed, train_model
from signregraph.datasets import build_dataset
from signregraph.models import build_model
from signregraph.utils import collect_env, get_root_logger, mc_off, mc_on, test_port
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        # save signregraph version, config file content and class names in
        # checkpoints as meta data
        cfg.checkpoint_config.meta = dict(
            signregraph_version=__version__ + get_git_hash(digits=7),
