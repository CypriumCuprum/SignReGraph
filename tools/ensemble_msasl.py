...
# label = load_label('./data/signlanguage_msasl/1000msasl_focushand_w_face.pkl', 'test')
# label = load_label('./data/signlanguage_msasl/200msasl_focushand_w_face.pkl', 'test')
label = load_label('./data/signlanguage_msasl/100msasl_focushand_w_face.pkl', 'test')
