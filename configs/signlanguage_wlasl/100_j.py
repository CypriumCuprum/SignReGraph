...
modality = 'j'
graph = 'sign_language'
work_dir = f'./work_dirs/signlanguage_wlasl/100_joint_{datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")}'
load_from = ""
...
ann_file = "./data/signlanguage_wlasl/100wlasl_focus_hand_w_face.pkl"
