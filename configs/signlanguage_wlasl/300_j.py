...
modality = 'j'
graph = 'sign_language'
work_dir = f'./work_dirs/signlanguage_wlasl/300_joint_{datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")}'
load_from = ""
...
model = dict(
    ...
    cls_head=dict(type='SimpleHead', joint_cfg='sign_language', num_classes=300, in_channels=384, weight=1.0))

dataset_type = 'PoseDataset'
ann_file = "./data/signlanguage_wlasl/300wlasl_focus_hand_w_face.pkl"
