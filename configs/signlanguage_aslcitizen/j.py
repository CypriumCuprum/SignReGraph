...
modality = 'j'
graph = 'sign_language'
work_dir = f'./work_dirs/signlanguage_aslcitizen/Joint_{datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")}'
...
model = dict(
    ...
    cls_head=dict(type='SimpleHead', joint_cfg='sign_language', num_classes=2731, in_channels=384, weight=1.0))

dataset_type = 'PoseDataset'
ann_file = "./data/signlanguage_asl_citizen/2731asl_citizen.pkl"
