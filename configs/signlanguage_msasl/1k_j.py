...
modality = 'j'
graph = 'sign_language'
work_dir = f'./work_dirs/signlanguage_msasl/1k_joint_{datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")}'
load_from = ""
...
model = dict(
    ...
    cls_head=dict(type='SimpleHead', joint_cfg='sign_language', num_classes=1000, in_channels=384, weight=1.0))

dataset_type = 'PoseDataset'
ann_file = "./data/signlanguage_msasl/1000msasl_focushand_w_face.pkl"
