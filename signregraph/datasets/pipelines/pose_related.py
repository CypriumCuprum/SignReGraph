...
class JointToBone:
    ...
    def __init__(self, dataset='nturgb+d', target='keypoint'):
        self.dataset = dataset
        self.target = target
        if self.dataset not in ['nturgb+d', 'openpose', 'openpose_new', 'coco', 'coco_new', 'sign_language']:
            raise ValueError(
        ...
        elif self.dataset == 'sign_language':
            self.pairs = ((0, 1), (1, 0), (2, 0), (3, 1), (4, 2), (5, 3), 
                          (6, 7), (7, 8), (8, 9), (9, 10), (10, 10),
                          (11, 6), (12, 11), (13, 12), (14, 13), 
                          (15, 6), (16, 15), (17, 16), (18, 17),
                          (19, 6), (20, 19), (21, 20), (22, 21), 
                          (23, 6), (24, 23), (25, 24), (26, 25),
                          (27, 28), (28, 29), (29, 30), (30, 31), (31, 31),
                          (32, 27), (33, 32), (34, 33), (35, 34),
                          (36, 27), (37, 36), (38, 37), (39, 38),
                          (40, 27), (41, 40), (42, 41), (43, 42),
                          (44, 27), (45, 44), (46, 45), (47, 46),
                          (48, 49), (49, 50), (50, 51), (51, 52), (52, 53), (53, 54), (54, 55), (55, 56), (56, 57), (57, 58), (58, 59), (59, 60), (60, 61), (61, 62), (62, 63), (63, 64), (64, 48),
                          (65, 66), (66, 67), (67, 68), (68, 69), (69, 70), (70, 71), (71, 72), (72, 73), (73, 74), (74, 75), (75, 76), (76, 65))
    ...
    def __call__(self, results):
        ...
        for v1, v2 in self.pairs:
            ...
            if C == 3 and self.dataset in ['openpose', 'openpose_new', 'coco', 'coco_new', 'handmp', 'sign_language']:
